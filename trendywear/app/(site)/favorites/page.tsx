...
import { fetchFavorites, Product , SortOption} from "../lib/fetchFavorites";
...
function FavoritesContent() {
  ...
  useEffect(() => {
    setLoading(true);
    fetchFavorites(searchQuery, activeCategory, sortBy) // pass category to server
      .then(setFavorites)
  ...
  }, [favorites, price, minRating, selectedColors, selectedSubCategories, selectedSize]);
        ...
        <main className="max-w-[1440px] mx-auto px-10 py-10">
          <div className="grid grid-cols-[260px_1fr] gap-14 items-start">
            ...
            <section>
              ...
              <h1 className="text-4xl font-bold text-[#C1121F] mb-4">Favorites</h1>
